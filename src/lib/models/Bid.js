...
export default modelCache => {
  ...
  return modelCache.db.define(
    "bid",
    {
      ...
      price: {
        type: DataTypes.DECIMAL(10, 2), // eslint-disable-line new-cap
        allowNull: false,
      },
      priceF: {
    ...
    {
      indexes: [{ fields: ["userId"] }, { fields: ["routeId"] }],
      ...
      classMethods: {
        async createForUserAndRoute(userInst, routeInst, price, options = {}) {
          ...
          InvalidArgumentError.assert(
            !existingBid,
            "A bid has already been made for this route"
          )
